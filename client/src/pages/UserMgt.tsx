...
import { ADD_USER, UPDATE_USER, DEACTIVATE_USER, DELETE_USER } from "../utils/mutations";
    ...
    <main className="container-fluid px-3">
      ...
      <div className="section">
        ...
        <form
          ...
          className="form row g-3 align-items-center"
        >
              ...
              {users.map((user) => (
                <tr key={user._id}>
                  ...
                  <td>
                    ...
                    <button
                      onClick={() =>
                        handleDeactivateUser(user._id, user.status)
                      }
